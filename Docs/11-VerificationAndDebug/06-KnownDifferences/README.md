...
| ID | 差异 | 证据/现状 | 验收状态 |
| --- | --- | --- | --- |
| VIS-BG-01 | 战斗背景缺 cloudBase/hills/frontClouds/backClouds 视差 | `Water.as::advance` 有明确系数；Unity 无对应组件 | 未实现 |
...
| VIS-FRONT-01 | 前端水面、云、山体的循环位移未实现 | `MenuBackgroundAnim.as`；Unity 仅绘制静态 background | 未实现 |
