var §\x01§ = 99;
var §\x0f§ = 1;
class com.nitrome.throwgame.Character extends com.nitrome.throwgame.Solid
{
   var advanceMotion;
   var aiMoveList;
   var aiThrowsToCheck;
   ...
   var mapVisibility = 1;
   var aiFinished = true;
   var aiThrowChecked = false;
   var aiWeaponsChecked = 0;
   var aiRemember = null;
   var canThrow = true;
   var canShoot = true;
   var evilness = 0;
   var luck = 5;
   var contactTime = 0;
   function Character(linkageName)
   {
   ...
   function setWeapons(weaponsAttributes)
   {
      this.hasWeapons = [];
   ...
   function numberOfWeapon(weapon)
   {
      var _loc3_ = 0;
      var _loc2_ = 0;
   ...
   function firstIndexOfWeapon(weapon)
   {
      var _loc2_ = 0;
      while(_loc2_ < this.hasWeapons.length)
      {
   ...
   function weaponIsInfinite(weapon)
   {
      var _loc2_ = 0;
