      ...
      else
      {
                     ...
                     if(eval("\x01") == 774)
                     {
                        ...
                        if(!_global.mx.core.UIObject)
                        {
                           ...
                           _loc2_.getStyle = function(styleProp)
                           {
                              ...
                              if(_loc6_ != undefined)
                              {
                                 if(typeof _loc6_ != §§constant(150))
                                 {
                                    _loc3_ = _loc6_[§§constant(156)](styleProp);
                                 }
                                 else
                                 {
                                    _loc7_ = _global[§§constant(123)][_loc6_];
                                    _loc3_ = _loc7_[§§constant(156)](styleProp);
                                 }
                              }
                              if(_loc3_ != undefined)
                              {
                              ...
                              var _loc5_;
                              if(_global[§§constant(118)])
                              {
                                 if(eval("{invalid_utf8=186}{invalid_utf8=196}={invalid_utf8=214}")[§§constant(123)][§§constant(128)][§§constant(159)](styleProp) || eval("{invalid_utf8=186}{invalid_utf8=196}={invalid_utf8=214}")[§§constant(123)][§§constant(128)][§§constant(160)](styleProp))
                                 {
                                    _loc5_ = this[§§constant(119)];
                                    if(_loc5_ != undefined)
                                    {
                                    ...
                                    if(this[§§constant(19)] != undefined)
                                    {
                                       _loc3_ = this[§§constant(19)][§§constant(156)](styleProp);
                                    }
                                    else
                                    {
                                       _loc3_ = _global[§§constant(151)][styleProp];
                                    }
                                    if(_loc5_ != undefined)
                                    {
         ...
         else
         {
            if(eval("\x01") == 739)
            {
               ...
               _loc7_ = (mx.core.UIObject = function()
               {
                  super();
                  this.constructObject();
               })[§§constant(120)]();
               ...
               if(_global[§§constant(118)])
               {
                  if(eval("{invalid_utf8=186}{invalid_utf8=196}={invalid_utf8=214}")[§§constant(123)][§§constant(128)][§§constant(159)](styleProp) || eval("{invalid_utf8=186}{invalid_utf8=196}={invalid_utf8=214}")[§§constant(123)][§§constant(128)][§§constant(160)](styleProp))
                  {
                     _loc5_ = mx.core.UIObject = function()
                     {
                        super();
                        this.constructObject();
                     }[§§constant(119)];
                     ...
                     if(mx.core.UIObject = function()
                     {
                        super();
                        this.constructObject();
                     }[§§constant(19)] != undefined)
                     {
                        _loc3_ = mx.core.UIObject = function()
                        {
                           super();
                           this.constructObject();
                        }[§§constant(19)][§§constant(156)](styleProp);
                     }
                     else
                     {
                        _loc3_ = _global[§§constant(151)][styleProp];
            ...
            else
            {
               if(eval("\x01") != 449)
               {
                  if(eval("\x01") == 989)
                  {
                     ...
                     {
                        _loc2_ = mx.styles.CSSStyleDeclaration = function()
                        {
                        }.prototype;
                        _loc2_.__getTextFormat = function(tf, bAll)
                        {
                        ...
                        mx.styles.CSSStyleDeclaration = function()
                        {
                        ...
                        mx.styles.CSSStyleDeclaration = function()
                        {
                        }.classConstructed = mx.styles.CSSStyleDeclaration.classConstruct();
                        mx.styles.CSSStyleDeclaration = function()
                        {
                        }.CSSTextStylesDependency = mx.styles.CSSTextStyles;
                        §§push(ASSetPropFlags(mx.styles.CSSStyleDeclaration.prototype,null,1));
                     }
                     §§pop();
                     break;
                  }
